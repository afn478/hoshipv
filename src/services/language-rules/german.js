...
const IINATAN_GERMAN_YOMITAN_PREFIX_RULES = [["un", "", [], ["adj"], "negative"]];

module.exports = {
  separablePrefixes: IINATAN_GERMAN_YOMITAN_SEPARABLE_PREFIXES,
  localSeparablePrefixes: IINATAN_GERMAN_LOCAL_SEPARABLE_PREFIXES,
  suffixRules: IINATAN_GERMAN_YOMITAN_SUFFIX_RULES,
  localSuffixRules: IINATAN_GERMAN_LOCAL_SUFFIX_RULES,
  prefixRules: IINATAN_GERMAN_YOMITAN_PREFIX_RULES,
};
