 ...
 * License: GPL-3.0-or-later. See docs/deinflection.md for attribution notes.
 */
...
module.exports = {
  suffixRules: IINATAN_ENGLISH_YOMITAN_SUFFIX_RULES,
  prefixRules: IINATAN_ENGLISH_YOMITAN_PREFIX_RULES,
  doubledSuffixRules: IINATAN_ENGLISH_YOMITAN_DOUBLED_SUFFIX_RULES,
};
