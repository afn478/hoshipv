...
(() => {
  ...
  function isTextSelectionTarget(target) {
    ...
    return !target.closest(
      'button, a, input, select, textarea, summary, [data-action], .cross-reference, [contenteditable="true"]',
    );
  }
  ...
  const NESTED_IGNORED_SELECTOR =
    'button, a, input, select, textarea, summary, [data-action], rt, svg, [contenteditable="true"]';
