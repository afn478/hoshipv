...
(function () {
  ...
  IINATAN.geometryRequestForSubtitle = function (sub) {
    ...
    return {
      ...
      font: {
        ...
        size: Number(props["sub-font-size"] || 38) * Number(props["sub-scale"] || 1),
  ...
  IINATAN.updateSubtitleGeometry = function () {
    ...
    var key = JSON.stringify([subtitles, IINATAN.state.properties["sid"], IINATAN.state.properties["secondary-sid"], IINATAN.state.properties["track-list"], osd, IINATAN.state.properties["video-out-params"], IINATAN.state.properties["sub-font"], IINATAN.state.properties["sub-font-size"], IINATAN.state.properties["sub-bold"], IINATAN.state.properties["sub-italic"], IINATAN.state.properties["sub-spacing"], IINATAN.state.properties["sub-line-spacing"], IINATAN.state.properties["sub-margin-x"], IINATAN.state.properties["sub-margin-y"], IINATAN.state.properties["sub-align-x"], IINATAN.state.properties["sub-align-y"], IINATAN.state.properties["sub-justify"], IINATAN.state.properties["sub-use-margins"], IINATAN.state.properties["sub-pos"], IINATAN.state.properties["secondary-sub-pos"], IINATAN.state.properties["sub-scale"], IINATAN.state.properties["sub-scale-by-window"], IINATAN.state.properties["sub-scale-with-window"], IINATAN.state.properties["sub-ass-override"]]);
