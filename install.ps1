...
Copy-Item (Join-Path $ArchiveRoot "scripts\iinatan.js") (Join-Path $MpvHome "scripts\iinatan.js") -Force
...
Write-Host "Installed iinatan script at $(Join-Path $MpvHome 'scripts\iinatan.js')"
